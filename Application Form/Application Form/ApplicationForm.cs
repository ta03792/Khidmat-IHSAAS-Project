    ...
    public partial class ApplicationForm : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                d.Inserts("EXEC New_Applicant '" + ApplicationNumber.Text + "','" + CNIC_1.Text.ToString() + "','" + FirstName.Text + "','" + LastName.Text + "','" + FatherName.Text + "','" + CellNumber.Text + "','" + DateInitiated.Value + "','" + Address.Text + "','" + i + "','" + Religion.Text + "','" + Sect.Text + "'");
        ...
        {
            DocumentsForm formDoc = new DocumentsForm(ApplicationNumber.Text.ToString());
            formDoc.Show();
        ...
        private void UpdateButton_Click(object sender, EventArgs e)
        {
            ...
            d.Update("Update dbo.Application Set FirstName ='" + FirstName.Text + "', CNIC = '" + CNIC_1.Text + "', LastName = '" + LastName.Text + "',FatherName = '" + FatherName.Text + "', CellNo = '" + CellNumber.Text + "', DateInitiated = '" + DateInitiated.Value + "', Address = '" + Address.Text + "', Payment = '" + i + "' Where ApplicationNumber = '" + ApplicationNumber.Text + "'");
