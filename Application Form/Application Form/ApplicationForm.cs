    ...
    public partial class ApplicationForm : Form
    {
...

        {
            ...
            else if (val == false)
            {
                ...
                //Updating stream
                DataTable theData1 = d.Select("SELECT * FROM Stream_has_Application WHERE ApplicationNumber = " + appNo);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            d.Inserts("INSERT INTO dbo.DeductableDues VALUES ('" + TCountableAssets.Text + "','" + TDeductableDues.Text + "','" + NCountableAssets.Text + "','" + CAmountZakat.Text + "'");
